...
class LoginRepoImpl extends AuthRepo {
  ...
  final BaseAuthDataRemote baseAuthDataRemote;
  final AuthRemoteDataSource remoteDataSource;

  LoginRepoImpl(
      this.firebaseAuthService, this.baseAuthDataRemote, this.remoteDataSource);
  ...
  Future<Either<Failure, LoginUserEntity>> signinWithEmailAndPassword(
    ...
    try {
      ...
      if (user != null) {
        ...
        return Left(
            ServerFailure(statusCode: "404", errMessage: "User not found."));
      }
  ...
  @override
  Future<Either<Failure, LoginUserEntity>> signInWithGoogle() async {
    try {
      ...
      if (user != null) {
        ...
        return Left(ServerFailure(
            statusCode: "400", errMessage: "Google Sign-In failed."));
      }
    } on FirebaseAuthException catch (e) {
      return Left(ServerFailure(
        statusCode: e.code,
      ...
      log('Exception in LoginRepoImpl.signInWithGoogle: ${e.toString()}');
      return Left(ServerFailure(
        statusCode: "500",
        errMessage: 'An unexpected error occurred. Please try again later.',
      ));
